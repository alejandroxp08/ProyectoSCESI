...
class SeriesPage extends StatelessWidget {
  final VoidCallback naruto_series1;
  SeriesPage({
    Key key,
    this.naruto_series1,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xffa7c0cd),
      body: Stack(
        children: <Widget>[
          Transform.translate(
                    ...
                    Transform.translate(
                      ...
                      child:
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image:
                                const AssetImage('assets/images/series_s.png'),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
...
const String _svg_j180do =
    '<svg viewBox="30.0 466.0 310.0 39.0" ><path transform="translate(30.0, 466.0)" d="M 15 0 L 295 0 C 303.2842712402344 0 310 6.715728759765625 310 15 L 310 24 C 310 32.28427124023438 303.2842712402344 39 295 39 L 15 39 C 6.715728759765625 39 0 32.28427124023438 0 24 L 0 15 C 0 6.715728759765625 6.715728759765625 0 15 0 Z" fill="#4b636e" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
